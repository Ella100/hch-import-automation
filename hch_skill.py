...
# 导入核心自动化类
from api_automation import HCHAPIAutomation, clean_token
...
class HCHSkillExecutor:
    ...
    def _run_full_flow(
        ...
        try:
            ...
            submitter_api.headers["Authorization"] = f"Bearer {clean_token(submitter_token)}"
            ...
            approver_api.headers["Authorization"] = f"Bearer {clean_token(approver_token)}"
